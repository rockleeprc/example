...
/**
 * @see http://www.cnblogs.com/xrq730/p/6972268.html
 * @author liyan
 *
 */
@Intercepts({
...
public class SqlCostInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		System.err.println("interceptor intercept..." + invocation.getTarget());
		Object target = invocation.getTarget(); // 被代理对象
		Method method = invocation.getMethod(); // 代理方法
		Object[] args = invocation.getArgs(); // 方法参数
		System.err.printf("取值 ：target %s  \n method %s \n args %s", target, method, Arrays.toString(args));
...
//			System.err.println("interceptor wrap..." + target);
...
//		}
	...
	public void setProperties(Properties properties) {
		System.err.println(properties.getProperty("username"));
